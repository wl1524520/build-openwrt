...
PK_ADD="luci-mod-rpc luci-app-dnspod smartdns luci-app-smartdns luci-i18n-smartdns-zh-cn luci-app-frpc luci-i18n-arpbind-zh-cn luci-i18n-autoreboot-zh-cn luci-i18n-flowoffload-zh-cn luci-i18n-nlbwmon-zh-cn luci-i18n-ramfree-zh-cn luci-i18n-upnp-zh-cn luci-i18n-wol-zh-cn coreutils-nohup"
