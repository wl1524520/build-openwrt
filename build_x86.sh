...
PK_VPN="luci-app-openvpn-server luci-i18n-openvpn-server-zh-cn luci-app-wireguard luci-i18n-wireguard-zh-cn luci-proto-wireguard"
...
# PK_DDNS="-luci-app-ddns -luci-i18n-ddns-zh-cn -ddns-scripts_aliyun -ddns-scripts_dnspod"
PK_DDNS="luci-app-ddns luci-i18n-ddns-zh-cn"
PK_ADD="luci-mod-rpc luci-app-frpc luci-i18n-arpbind-zh-cn luci-i18n-autoreboot-zh-cn luci-i18n-nlbwmon-zh-cn luci-i18n-ramfree-zh-cn luci-i18n-upnp-zh-cn luci-i18n-wol-zh-cn luci-app-flowoffload luci-i18n-flowoffload-zh-cn coreutils-nohup bind-dig"
PK_DEL=" -alsa-utils -automount -autosamba -block-mount -kmod-8139cp -kmod-8139too -kmod-r8125 -kmod-ac97 -kmod-ath10k -kmod-ath5k -kmod-ath9k -kmod-ath9k-htc -kmod-rt2800-usb -kmod-sound-hda-codec-realtek -kmod-sound-hda-codec-via -kmod-sound-hda-core -kmod-sound-via82xx -kmod-usb-audio -kmod-usb-net -kmod-usb-net-asix -kmod-usb-net-asix-ax88179 -kmod-usb-net-rtl8150 -kmod-usb-net-rtl8152 -luci-app-accesscontrol -luci-app-adbyby-plus -luci-app-filetransfer -luci-app-ipsec-vpnd -luci-app-pptp-server -luci-app-transmission -luci-app-v2ray-server -luci-app-vlmcsd -luci-app-vsftpd -luci-app-xlnetacc -luci-app-zerotier -wpad -luci-app-qbittorrent -kmod-ipt-offload -luci-app-airplay2 -luci-app-cpufreq -luci-app-sfe -luci-i18n-sfe-zh-cn -luci-app-dnspod"
...
make image PACKAGES="${PK_ADD} ${PK_DDNS} ${PK_THEME} ${PK_VPN} ${PK_DEL} ${PK_DEL_FM}"
