...
PK_DNS_FWD="luci-app-dnsforwarder luci-i18n-dnsforwarder-zh-cn"
PK_THEME="luci-theme-netgear luci-i18n-base-zh-cn luci-i18n-firewall-zh-cn"
PK_ADD="luci-mod-rpc luci-app-dnspod smartdns luci-app-smartdns luci-app-frpc luci-i18n-arpbind-zh-cn luci-i18n-autoreboot-zh-cn luci-i18n-flowoffload-zh-cn luci-i18n-nlbwmon-zh-cn luci-i18n-ramfree-zh-cn luci-i18n-upnp-zh-cn luci-i18n-wol-zh-cn coreutils-nohup"
...
make image PACKAGES="${PK_ADD} ${PK_THEME} ${PK_DNS_FWD} ${PK_VPN} ${PK_DEL} ${PK_DEL_FM}" FILES=../files/x86_64/
