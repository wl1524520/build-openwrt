...
PKG="-opkg -kmod-i40evf -automount -autosamba -luci-app-adbyby-plus -luci-app-ipsec-vpnd -luci-proto-bonding luci-app-unblockmusic luci-app-zerotier -luci-app-xlnetacc -luci-app-wireguard luci-app-ttyd -kmod-sound-hda-core -kmod-sound-hda-codec-realtek -kmod-sound-hda-codec-via -kmod-sound-via82xx -kmod-sound-hda-intel -kmod-sound-hda-codec-hdmi -kmod-sound-i8x0 -kmod-usb-audio -kmod-usb-net -kmod-usb-net-asix-ax88179 -kmod-usb-net-rtl8150 -kmod-usb-net-rtl8152-vendor -kmod-mlx4-core -kmod-mlx5-core -kmod-drm-i915 -block-mount ddns-scripts_aliyun ddns-scripts_dnspod luci-app-ddns luci-app-upnp luci-app-autoreboot luci-app-arpbind -luci-app-filetransfer -luci-app-vsftpd luci-app-ssr-plus -luci-app-vlmcsd -luci-app-accesscontrol -luci-app-nlbwmon luci-app-turboacc luci-app-wol luci-app-firewall"
